...
def _require_plotting_tools():
    # Keep plotting imports lazy so non-visual pipelines can run headless.
    import matplotlib
...
def plot_trajectory(
    ...
    plot_mode = best_plotmode(gt_traj if (gt_traj is not None) else pred_traj, plot)
