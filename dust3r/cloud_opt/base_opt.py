...
class BasePCOptimizer (nn.Module):
    ...
    def _init_from_views(self, view1, view2, pred1, pred2,
        ...
        if 'camera_intrinsics' in view1 and 'camera_intrinsics' in view2:
            camera_intrinsics = [torch.zeros((3, 3)) for _ in range(self.n_imgs)]
            for v in range(len(self.edges)):
                idx = view1['idx'][v]
                camera_intrinsics[idx] = view1['camera_intrinsics'][v]
                idx = view2['idx'][v]
                camera_intrinsics[idx] = view2['camera_intrinsics'][v]
